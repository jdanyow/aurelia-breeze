System.register(['aurelia-binding', './expression-analyzer', './error-renderer'], function (_export) {
  'use strict';

  var bindingMode, ExpressionAnalyzer, ErrorRenderer, BreezeValidationCustomAttribute;
  ...
  return {
    ...
    }, function (_expressionAnalyzer) {
      ExpressionAnalyzer = _expressionAnalyzer.ExpressionAnalyzer;
    }, function (_errorRenderer) {
      ErrorRenderer = _errorRenderer.ErrorRenderer;
    }],
    execute: function () {
      BreezeValidationCustomAttribute = (function () {
        _createClass(BreezeValidationCustomAttribute, null, [{
          key: 'inject',
          value: [Element, ExpressionAnalyzer, ErrorRenderer],
          enumerable: true
        }]);
      ...
      _export('BreezeValidationCustomAttribute', BreezeValidationCustomAttribute);
    }
  };
});